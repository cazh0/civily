    ...
    Column(
        ...
        FactSection(
            ...
            facts = listOf(
                ...
                // Both are hidden at zero rather than shown as "0": a nation nobody endorses is
                // the ordinary case outside the World Assembly, and a tile saying so is noise.
                Fact(
        ...
        FactSection(
            ...
            facts = listOf(
                ...
                Fact(stringResource(R.string.label_major_industry), nation.economy.majorIndustry),
            ),
            columns = PAIRED,
        )
