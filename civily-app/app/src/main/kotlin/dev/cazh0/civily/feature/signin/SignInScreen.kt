package dev.cazh0.civily.feature.signin
...
fun SignInScreen(
    ...
    // The same form does both jobs, and saying which one it is doing is the whole difference
    // between "sign in again?" and "this is the second nation you asked for".
    val adding = accounts.all.isNotEmpty()
        ...
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        stringResource(
                            if (adding) R.string.title_add_nation else R.string.title_sign_in,
                        ),
                    )
                },
                navigationIcon = {
